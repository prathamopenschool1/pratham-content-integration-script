...
def json_parent_tree():
    ...
    catalog_tree = {
        ...
        "content_id": "PrathamOpenSchool Content",
    ...
    try:
        for item in topics_data["items"]:
            if item["content_id"] == '12':
                print("finding........................")
                subtree = get_all_json(item["content_id"])
                catalog_tree['children'].append(subtree)
            else:
                pass
        return catalog_tree
    except Exception as e:
        print(e, "parent error")
        pass

# @pysnooper.snoop()
def get_all_json(content_id):
    try:
